## Hi there, I'm Vamsi Andavarapu 👋

🎓 CS Graduate (Data Science) · ⚙️ AI Engineer · 💻 Full-Stack Developer
...
- ⚙️ Passionate about AI Engineering — designing and deploying intelligent systems from model to production.
- 🤖 Building AI-powered apps with Python, TensorFlow, Scikit-learn, RAG, Llama 3.2 & ChromaDB.
- 💻 Full-Stack Developer skilled in Software Engineering, Data Analytics & Machine Learning.
...
**⚙️ Backend**
`Node.js` `Express.js` `FastAPI` `Django` `REST APIs` `MongoDB` `MySQL`

**🤖 AI / ML & Data Science**
`TensorFlow` `PyTorch` `Scikit-learn` `Pandas` `NumPy` `Matplotlib` `RAG` `Llama 3.2` `ChromaDB` `LangChain`
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=VamsiAndavarapu&show_icons=true&theme=dark&include_all_commits=true&count_private=true" alt="GitHub Stats" />
</p>

<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=VamsiAndavarapu&theme=dark" alt="GitHub Streak" />
</p>
